...
export default function Echos(){
    const servicios = [
        {
            icon: "/acrylic.png", // woman.png no existe, usando acrylic.png como alternativa
        ...
        {
            icon: "/femenine.png", // Esta imagen sí existe ✅
        ...
        {
            icon: "/feet.png", // womans.png no existe, usando feet.png como alternativa
